...
app.get('/', function(req, resp){
	...
	resp.sendFile('administracao.html', {root: path.join(__dirname, '')});
});
...
app.post('/', function(req, res){
	res.send('O administrador está logado:'+req.body.Login);
});

/*
SELECT ta.nome, ta.sobrenome


FROM tabela ta, nacionalidade na
